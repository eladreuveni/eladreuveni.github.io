...
// This is some code I found online. It's a simple component that renders an icon based on the weather code.
...
const WeatherIcon: FC<Props> = ({ code }) => {
    ...
    switch (code) {
        ...
        case 25: icon = 'wi-thermometer'; break;
